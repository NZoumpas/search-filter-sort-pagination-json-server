...
function App() {
  ...
  //Load Data with axios responce
  const loadUserData = async (start, end, increase) => {
    return await axios(`http://localhost:5000/users?_start=${start}&_end=${end}`)
      .then((responce) => {
  ...
  //Handle Filter Active/Inactive input field
